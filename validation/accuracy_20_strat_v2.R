...
classP <- rast("/media/hkropp/research/Kolyma_Data/predictions/v2/maps/class2020_strat_v2.tif") 
...
writeVector(pointsComp,"/media/hkropp/research/Kolyma_Data/predictions/v2/maps/valid_class2020_strat_2.shp")
