...
dirP <- "/media/hkropp/research/Kolyma_Data/predictions/1971_k5"
...
dirP2 <- "/media/hkropp/research/Kolyma_Data/predictions/1971_k5_2"
...
tiles2 <- list()
for(i in 1:Nimg){
  tiles2[[i]] <- rast(paste0("/media/hkropp/research/Kolyma_Data/img_tiles/1971e/img_256_2/img",i,".tif"))
...
dirP3 <- "/media/hkropp/research/Kolyma_Data/predictions/1971_k5_3"
...
tiles3 <- list()
for(i in 1:Nimg){
  tiles3[[i]] <- rast(paste0("/media/hkropp/research/Kolyma_Data/img_tiles/1971e/img_256_3/img",i,".tif"))
