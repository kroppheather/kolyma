...
# version 3 increases shrub threshold to 0.7
...
writeRaster(finalClass, "/media/hkropp/research/Kolyma_Data/predictions/maps/class2020_k5_v3.tif", filetype="GTiff" )
